...
const (
	...
	ErrFailedClearDisk
	ErrFailedGetSlotMap
	ErrFailedGetPciDevMap
	ErrFailedGetDevOsdMap
	ErrFailedGetVip
)
...
var ErrorCodeResponse = map[ApiErrorCode]ApiErrorStruct{
	...
	ErrFailedClearDisk: {
		ErrorCode:      "Failed clear disk",
		Description:    "Failed clear disk",
		HttpStatusCode: http.StatusInternalServerError,
	},
	ErrFailedGetSlotMap: {
		ErrorCode:      "Failed get slot map",
		Description:    "Failed get slot map",
		HttpStatusCode: http.StatusInternalServerError,
	},
	ErrFailedGetPciDevMap: {
		ErrorCode:      "Failed get pci dev map",
		Description:    "Failed get pci dev map",
		HttpStatusCode: http.StatusInternalServerError,
	},
	ErrFailedGetDevOsdMap: {
		ErrorCode:      "Failed get dev osd map",
		Description:    "Failed get dev osd map",
		HttpStatusCode: http.StatusInternalServerError,
	},
	ErrFailedGetVip: {
